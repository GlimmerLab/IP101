...
void test_performance(const Mat& src1, const Mat& src2, const string& method_name) {
    ...
    cout << method_name << " score: " << score << endl;
...
void compare_with_opencv(const Mat& src1, const Mat& src2, const string& method_name) {
    ...
    cout << "Our implementation: " << score_ours << ", time: " << duration_ours.count() << "ms" << endl;
    cout << "OpenCV implementation: " << score_opencv << ", time: " << duration_opencv.count() << "ms" << endl;
    cout << "Speed ratio: " << (float)duration_opencv.count() / duration_ours.count() << "x" << endl;
    cout << "Score difference: " << abs(score_ours - score_opencv) << endl;
}
